...
AI_DISCLAIMER = "This review was generated by AI. Always verify suggestions before applying."
...
def format_summary_comment(
    ...
    if overview:
        parts.append(f"<h2>{logo} Pull request overview <sub>v{VERSION}</sub></h2>\n\n{overview}")
