...
What it does:
  ...
  5. Outputs the encrypted blob to set as HAWKEYE_CLAUDE_API_TOKEN in your repo
...
GitHub repo variable setup (one-time per repo):
  ...
  3. Create HAWKEYE_CLAUDE_API_TOKEN = the encrypted blob printed by this script
"""
...
def main() -> None:
    ...
    print()
    print("=" * 60)
    print("Encrypted blob (copy this as HAWKEYE_CLAUDE_API_TOKEN):")
    print()
    print(blob)
    print()
    print("=" * 60)
    ...
    print("  3. Create variable: HAWKEYE_CLAUDE_API_TOKEN = <the blob above>")
    print()
